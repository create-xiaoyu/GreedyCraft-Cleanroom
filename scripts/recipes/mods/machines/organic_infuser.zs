...
val crops as IItemStack[][] = [
    ...
    [<jaopca:mysticalagriculture_seeds.scarlite>, <jaopca:mysticalagriculture_essence.scarlite>],
    [<jaopca:mysticalagriculture_seeds.cryonium>, <jaopca:mysticalagriculture_essence.cryonium>],
    [<jaopca:mysticalagriculture_seeds.ambrosium>, <jaopca:mysticalagriculture_essence.ambrosium>],
    ...
    [<jaopca:mysticalagriculture_seeds.asgardium>, <jaopca:mysticalagriculture_essence.asgardium>],
    [<jaopca:mysticalagriculture_seeds.aeroite>, <jaopca:mysticalagriculture_essence.aeroite>],
    [<jaopca:mysticalagriculture_seeds.umbrium>, <jaopca:mysticalagriculture_essence.umbrium>],
    [<mysticalagriculture:saltpeter_seeds>, <mysticalagriculture:saltpeter_essence>],
    [<jaopca:mysticalagriculture_seeds.netherite>, <jaopca:mysticalagriculture_essence.netherite>],
    [<mysticalagriculture:starmetal_seeds>, <mysticalagriculture:starmetal_essence>],
    [<mysticalagriculture:black_quartz_seeds>, <mysticalagriculture:black_quartz_essence>],
    [<jaopca:mysticalagriculture_seeds.aqualite>, <jaopca:mysticalagriculture_essence.aqualite>],
    [<jaopca:mysticalagriculture_seeds.manganese>, <jaopca:mysticalagriculture_essence.manganese>],
