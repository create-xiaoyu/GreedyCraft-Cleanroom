...
val crops as IItemStack[][] = [
    ...
    [<mysticalcreations:scarlite_seeds>, <mysticalcreations:scarlite_seeds>],
    [<mysticalcreations:cryonium_seeds>, <mysticalcreations:cryonium_seeds>],
    [<mysticalcreations:ambrosium_seeds>, <mysticalcreations:ambrosium_seeds>],
    [<mysticalcreations:hephaestite_seeds>, <mysticalcreations:hephaestite_seeds>],
    [<mysticalcreations:experience_seeds>, <mysticalcreations:experience_seeds>],
    [<mysticalcreations:dimensional_shard_seeds>, <mysticalcreations:dimensional_shard_seeds>],
    [<mysticalcreations:infernium_seeds>, <mysticalcreations:infernium_seeds>],
    [<mysticalcreations:liquified_coralium_seeds>, <mysticalcreations:liquified_coralium_seeds>],
    [<mysticalcreations:shadowium_seeds>, <mysticalcreations:shadowium_seeds>],
    [<mysticalcreations:cytosinite_seeds>, <mysticalcreations:cytosinite_seeds>],
    [<mysticalcreations:asgardium_seeds>, <mysticalcreations:asgardium_seeds>],
    [<mysticalcreations:aeroite_seeds>, <mysticalcreations:aeroite_seeds>],
    [<mysticalcreations:umbrium_seeds>, <mysticalcreations:umbrium_seeds>],
    [<mysticalagriculture:saltpeter_seeds>, <mysticalagriculture:saltpeter_essence>],
    [<mysticalcreations:netherite_seeds>, <mysticalcreations:netherite_seeds>],
    [<mysticalagriculture:starmetal_seeds>, <mysticalagriculture:starmetal_essence>],
    [<mysticalagriculture:black_quartz_seeds>, <mysticalagriculture:black_quartz_essence>],
    [<mysticalcreations:aqualite_seeds>, <mysticalcreations:aqualite_seeds>],
    [<mysticalcreations:manganese_seeds>, <mysticalcreations:manganese_seeds>],
