...
LootUtil.addHardmodeItem(<prefab:item_advanced_chicken_coop>.withTag({ForgeCaps: {"prefab:structuresconfiguration": {configuration: {wareHouseFacing: "north", structureEnumName: "AdvancedHorseStable"}}}, id: "prefab:item_advanced_chicken_coop", Count: 1 as byte, Damage: 0 as short}), 1, 1, 1, 1);
LootUtil.addHardmodeItem(<prefab:item_advanced_chicken_coop>.withTag({ForgeCaps: {"prefab:structuresconfiguration": {configuration: {wareHouseFacing: "north", structureEnumName: "AdvancedCoop"}}}, id: "prefab:item_advanced_chicken_coop", Count: 1 as byte, Damage: 0 as short}), 1, 1, 1, 1);
