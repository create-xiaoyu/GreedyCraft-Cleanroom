...
val emcMapping as long[IIngredient] = {
    ...
    <mysticalcreations:scarlite_seeds:0> : 0 as long,
    <mysticalcreations:aeroite_seeds:0> : 0 as long,
    <mysticalcreations:aqualite_seeds:0> : 0 as long,
    <mysticalcreations:asgardium_seeds:0> : 0 as long,
    <mysticalagriculture:starmetal_essence:0> : 0 as long,
    <mysticalcreations:experience_seeds:0> : 0 as long,
    <mysticalcreations:liquified_coralium_seeds:0> : 0 as long,
    <mysticalcreations:manganese_seeds:0> : 0 as long,
    <mysticalcreations:shadowium_seeds:0> : 0 as long,
    <mysticalcreations:umbrium_seeds:0> : 0 as long,
    <mysticalcreations:ambrosium_seeds:0> : 0 as long,
    <mysticalcreations:dimensional_shard_seeds:0> : 0 as long,
    <mysticalcreations:hephaestite_seeds:0> : 0 as long,
