...
val emcMapping as long[IIngredient] = {
    ...
    <jaopca:mysticalagriculture_essence.scarlite:0> : 0 as long,
    <jaopca:mysticalagriculture_essence.aeroite:0> : 0 as long,
    <jaopca:mysticalagriculture_essence.aqualite:0> : 0 as long,
    <jaopca:mysticalagriculture_essence.asgardium:0> : 0 as long,
    <mysticalagriculture:starmetal_essence:0> : 0 as long,
    <jaopca:mysticalagriculture_essence.experience:0> : 0 as long,
    <jaopca:mysticalagriculture_essence.liquified_coralium:0> : 0 as long,
    <jaopca:mysticalagriculture_essence.manganese:0> : 0 as long,
    <jaopca:mysticalagriculture_essence.shadowium:0> : 0 as long,
    <jaopca:mysticalagriculture_essence.umbrium:0> : 0 as long,
    <jaopca:mysticalagriculture_essence.ambrosium:0> : 0 as long,
    <jaopca:mysticalagriculture_essence.dimensional_shard:0> : 0 as long,
    <jaopca:mysticalagriculture_essence.hephaestite:0> : 0 as long,
    <mysticalagriculture:black_quartz_essence:0> : 0 as long,
    <mysticalagriculture:saltpeter_essence:0> : 0 as long,
